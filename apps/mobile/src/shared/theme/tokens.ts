 ...
 * 기획서 2.1.1 고정 팔레트(큐트-흑화 카툰)의 "도깨비불 민트"로 잡는다.
 *
 * 팔레트를 바꾸려면 기획서 2.1.1의 고정 팔레트 표부터 고친 뒤 이 파일의
 * 토큰 값만 교체한다 — 컴포넌트 코드에는 색 리터럴이 없어야 한다.
 */
...
export const colors = {
   ...
   * 단일 기능색. 기획서 2.1.1 고정 팔레트의 "도깨비불 민트" —
   * 스러져 가는 불꽃 색으로, 캐릭터 머리 위 불꽃 스프라이트와 같은 값.
   */
  accent: "#6fe3c1",
  accentBorder: "#45c9a2",
